...
export default function HeroSection({ blok }: { blok: HeroSectionBlok }) {
  ...
  return (
    <section
      {...editableProps}
      className="relative isolate overflow-hidden rounded-4xl border border-white/15 bg-slate-950 px-6 py-24 text-white shadow-[0_40px_120px_rgba(15,23,42,0.45)] sm:px-16 lg:px-24"
    >
      ...
      <div className="mx-auto flex  flex-col items-center gap-12 text-center lg:flex-row lg:items-start lg:text-left">
